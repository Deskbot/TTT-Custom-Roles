...
- Adds option `ttt_independent_warning` (Default: 0). At the start of the round, if there is a Jester, Swapper, or Killer, all players are warned that there is an "independent player".
