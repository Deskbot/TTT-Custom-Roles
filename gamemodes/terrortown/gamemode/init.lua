...
CreateConVar("ttt_firstpreptime", "60", FCVAR_ARCHIVE)
...
-- Player Spawning
CreateConVar("ttt_spawn_wave_interval", "0", FCVAR_ARCHIVE)
...
CreateConVar("ttt_zombie_pct", "0.33", FCVAR_ARCHIVE)
...
CreateConVar("ttt_detective_search_only", "1", FCVAR_REPLICATED + FCVAR_ARCHIVE)

-- Other
CreateConVar("ttt_use_weapon_spawn_scripts", "1", FCVAR_ARCHIVE)
CreateConVar("ttt_weapon_spawn_count", "0", FCVAR_ARCHIVE)

CreateConVar("ttt_round_limit", "6", FCVAR_ARCHIVE + FCVAR_NOTIFY + FCVAR_REPLICATED)
CreateConVar("ttt_time_limit_minutes", "75", FCVAR_ARCHIVE + FCVAR_NOTIFY + FCVAR_REPLICATED)
