...
CreateConVar("ttt_firstpreptime", "45")
...
CreateConVar("ttt_traitor_pct", "0.23")
CreateConVar("ttt_traitor_max", "4")

CreateConVar("ttt_detective_pct", "0.10", FCVAR_NOTIFY)
CreateConVar("ttt_detective_max", "1")
CreateConVar("ttt_detective_min_players", "9")
...
CreateConVar("ttt_zombie_chance", "0.05")
CreateConVar("ttt_hypnotist_chance", "1")
CreateConVar("ttt_vampire_chance", "0.1")
CreateConVar("ttt_assassin_chance", "0.1")
CreateConVar("ttt_glitch_chance", "0.25")
CreateConVar("ttt_phantom_chance", "0")
CreateConVar("ttt_mercenary_chance", "0.25")
CreateConVar("ttt_jester_chance", "0.05")
CreateConVar("ttt_swapper_chance", "0.05")
CreateConVar("ttt_killer_chance", "1")

CreateConVar("ttt_mercenary_required_innos", "6")
CreateConVar("ttt_hypnotist_required_traitors", "2")
CreateConVar("ttt_glitch_required_innos", "6")
CreateConVar("ttt_jester_required_innos", "4")
CreateConVar("ttt_phantom_required_innos", "2")
CreateConVar("ttt_vampire_required_traitors", "2")
CreateConVar("ttt_swapper_required_innos", "4")
CreateConVar("ttt_assassin_required_traitors", "2")
CreateConVar("ttt_killer_required_innos", "6")

CreateConVar("ttt_zombie_pct", "0.2")
...
CreateConVar("ttt_mer_credits_starting", "2")
CreateConVar("ttt_kil_credits_starting", "2")

CreateConVar("ttt_detective_search_only", "0", FCVAR_REPLICATED)
