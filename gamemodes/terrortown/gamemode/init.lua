...
CreateConVar("ttt_hypnotist_enabled", "1", FCVAR_NOTIFY)
CreateConVar("ttt_glitch_enabled", "1", FCVAR_NOTIFY)
CreateConVar("ttt_jester_enabled", "1", FCVAR_NOTIFY)
CreateConVar("ttt_phantom_enabled", "1", FCVAR_NOTIFY)
...
CreateConVar("ttt_killer_enabled", "1", FCVAR_NOTIFY)

CreateConVar("ttt_zombie_chance", "0.1", FCVAR_NOTIFY)
CreateConVar("ttt_hypnotist_chance", "0.2", FCVAR_NOTIFY)
CreateConVar("ttt_vampire_chance", "0.2", FCVAR_NOTIFY)
CreateConVar("ttt_assassin_chance", "0.2", FCVAR_NOTIFY)
CreateConVar("ttt_glitch_chance", "0.25", FCVAR_NOTIFY)
CreateConVar("ttt_phantom_chance", "0.25", FCVAR_NOTIFY)
CreateConVar("ttt_mercenary_chance", "0.25", FCVAR_NOTIFY)
CreateConVar("ttt_jester_chance", "0.25", FCVAR_NOTIFY)
CreateConVar("ttt_swapper_chance", "0.25", FCVAR_NOTIFY)
CreateConVar("ttt_killer_chance", "0.25", FCVAR_NOTIFY)

CreateConVar("ttt_mercenary_required_innos", "2", FCVAR_NOTIFY)
CreateConVar("ttt_hypnotist_required_traitors", "2", FCVAR_NOTIFY)
CreateConVar("ttt_glitch_required_innos", "2", FCVAR_NOTIFY)
CreateConVar("ttt_jester_required_innos", "2", FCVAR_NOTIFY)
CreateConVar("ttt_phantom_required_innos", "2", FCVAR_NOTIFY)
CreateConVar("ttt_vampire_required_traitors", "2", FCVAR_NOTIFY)
CreateConVar("ttt_swapper_required_innos", "2", FCVAR_NOTIFY)
CreateConVar("ttt_assassin_required_traitors", "2", FCVAR_NOTIFY)
CreateConVar("ttt_killer_required_innos", "3", FCVAR_NOTIFY)

CreateConVar("ttt_zombie_pct", "0.33", FCVAR_NOTIFY)
...
CreateConVar("ttt_mer_credits_starting", "1", FCVAR_NOTIFY)
CreateConVar("ttt_kil_credits_starting", "2", FCVAR_NOTIFY)

CreateConVar("ttt_detective_search_only", "1", FCVAR_NOTIFY + FCVAR_REPLICATED)
