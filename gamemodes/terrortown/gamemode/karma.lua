...
KARMA.cv.cleanmax = CreateConVar("ttt_karma_clean_bonus_max", "100", FCVAR_NOTIFY + FCVAR_ARCHIVE)
KARMA.cv.cleanmult = CreateConVar("ttt_karma_clean_bonus_multiplier", "1.2", FCVAR_NOTIFY + FCVAR_ARCHIVE)
...
KARMA.cv.jpenalty = CreateConVar("ttt_karma_jesterkill_penalty", "50", FCVAR_NOTIFY + FCVAR_ARCHIVE)
KARMA.cv.jratio = CreateConVar("ttt_karma_jester_ratio", "0.5", FCVAR_NOTIFY + FCVAR_ARCHIVE)
