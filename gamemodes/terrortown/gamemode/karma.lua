...
KARMA.cv.strict = CreateConVar("ttt_karma_strict", "1", FCVAR_ARCHIVE)
KARMA.cv.starting = CreateConVar("ttt_karma_starting", "1000", FCVAR_ARCHIVE)
KARMA.cv.max = CreateConVar("ttt_karma_max", "1000", FCVAR_ARCHIVE)
KARMA.cv.ratio = CreateConVar("ttt_karma_ratio", "0.001", FCVAR_ARCHIVE)
KARMA.cv.killpenalty = CreateConVar("ttt_karma_kill_penalty", "15", FCVAR_ARCHIVE)
KARMA.cv.roundheal = CreateConVar("ttt_karma_round_increment", "5", FCVAR_ARCHIVE)
KARMA.cv.clean = CreateConVar("ttt_karma_clean_bonus", "30", FCVAR_ARCHIVE)
KARMA.cv.cleanmax = CreateConVar("ttt_karma_clean_bonus_max", "100", FCVAR_ARCHIVE)
KARMA.cv.cleanmult = CreateConVar("ttt_karma_clean_bonus_multiplier", "1.2", FCVAR_ARCHIVE)
KARMA.cv.tbonus = CreateConVar("ttt_karma_traitorkill_bonus", "40", FCVAR_ARCHIVE)
KARMA.cv.tratio = CreateConVar("ttt_karma_traitordmg_ratio", "0.0003", FCVAR_ARCHIVE)
KARMA.cv.jpenalty = CreateConVar("ttt_karma_jesterkill_penalty", "50", FCVAR_ARCHIVE)
KARMA.cv.jratio = CreateConVar("ttt_karma_jester_ratio", "0.5", FCVAR_ARCHIVE)
KARMA.cv.debug = CreateConVar("ttt_karma_debugspam", "0", FCVAR_ARCHIVE)

KARMA.cv.persist = CreateConVar("ttt_karma_persist", "0", FCVAR_ARCHIVE)
KARMA.cv.falloff = CreateConVar("ttt_karma_clean_half", "0.25", FCVAR_ARCHIVE), FCVAR_ARCHIVE

KARMA.cv.autokick = CreateConVar("ttt_karma_low_autokick", "1", FCVAR_ARCHIVE)
KARMA.cv.kicklevel = CreateConVar("ttt_karma_low_amount", "450", FCVAR_ARCHIVE)
KARMA.cv.autoban = CreateConVar("ttt_karma_low_ban", "1", FCVAR_ARCHIVE)
KARMA.cv.bantime = CreateConVar("ttt_karma_low_ban_minutes", "60", FCVAR_ARCHIVE)
